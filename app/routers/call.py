...
async def get_call_by_id(call_id: int, session: AsyncSession = Depends(get_session)):
...
@router.get(path="/by_teamId/{team_id}",
            ...
            response_model=CallModelSchema)
async def get_call_by_team_id(team_id: int, session: AsyncSession = Depends(get_session)):
...
async def get_call_full_info(call_id: int, session: AsyncSession = Depends(get_session)):
...
@router.post(path="/",
             ...
             response_model=CallModelSchema)
async def create_call(new_call: CallCreateSchema, session: AsyncSession = Depends(get_session)):
...
@router.patch(path="/accept/{call_id}",
              ...
              response_model=CallModelSchema)
async def accept_call(call_id: int, team_id: int, session: AsyncSession = Depends(get_session)):
...
@router.patch(path="/reject/{call_id}",
              ...
              response_model=CallModelSchema)
async def reject_call(call_id: int, session: AsyncSession = Depends(get_session)):
...
@router.patch(path="/complete/{call_id}",
              ...
              response_model=CallModelSchema)
async def complete_call(call_id: int, session: AsyncSession = Depends(get_session)):
...
@router.patch(path="/trouble/{call_id}",
              ...
              response_model=CallModelSchema)
async def trouble_call(call_id: int, trouble_type: TroubleType, session: AsyncSession = Depends(get_session)):
